        ...
        methods: {
            ...
            gotoNew: function (riskControlPlaneByMonth) {
                ...
                $.post(projectName + "/RiskControlAnalyzeControl/goToNew/" + monthplaneID, {}, function (data) {
                    window.location.href = projectName + "/menu/RiskControlAnalyzeAdd.action";
                });
            },
            ...
            getNotAnalyzePlane: function () {
                var _self = this;
                $.post(projectName + "/RiskControlAnalyzeControl/getNotAnalyzePlane/" + _self.nowYear + "/" + _self.nowMonth + "/" + _self.monthType + "/" + _self.monthPlanFrequency, {}, function (data) {
            ...
            newObject: function () {
                $.post(projectName + "/RiskControlAnalyzeControl/gotoUpdate/0", function (data) {
                    window.location.href = "<%=request.getContextPath()%>/menu/RiskControlAnalyzeAdd.action";
                });
            },
