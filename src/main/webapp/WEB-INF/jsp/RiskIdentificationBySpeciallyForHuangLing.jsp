            ...
            <div class="col-sm-12">
              <div class="header-section">
                ...
                <div class="form-group" style="float: right; position: relative;right: 19px">
                  <%--<a type="submit" href="<%=request.getContextPath()%>/menu/RiskIdentificationBySpeciallyEntry.do" class="btn btn-effect-ripple btn-primary">新建</a>--%>
                    ...
                    <tr>
                      <%--<th style="width: 80px;" class="text-center">--%>
                        <%--<label class="csscheckbox csscheckbox-primary">--%>
                          <%--<input type="checkbox" v-model="checkedone" v-on:click="checkedAll">--%>
                          <%--<span></span>--%>
                        <%--</label>--%>
                      <%--</th>--%>
                  ...
                  <tbody>
                    <tr v-for="(risk,riskIndex) in listspcially">
                      <%--<td class="text-center">--%>
                        <%--<label class="csscheckbox csscheckbox-primary">--%>
                          <%--<input type="checkbox" v-bind:value="risk.riskidentificationSpeciallyID" v-model="checkIDs">--%>
                          <%--<span></span>--%>
                        <%--</label>--%>
                      <%--</td>--%>
                      ...
                      <td class="text-center">
                        <%--<a href="<%=request.getContextPath()%>/menu/RiskIdentificationBySpeciallyEntry.do" data-toggle="tooltip" class="btn btn-effect-ripple btn-sm btn-success" @click="" title="修改">--%>
