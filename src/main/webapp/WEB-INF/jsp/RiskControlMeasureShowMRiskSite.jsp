                ...
                <div class="">
                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li><a href="<%=request.getContextPath()%>/menu/RiskControlMeasure.do"
                    ...
                    <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                        <tr class="biaot">
                            ...
                            <tr>
                                ...
                                <td v-show="showOrNot('Name')"><i class="fa fa-caret-right fa-fw"></i> <a
                ...
                <div class="modal-body" style="height: 100%;overflow-y: auto">
                    ...
                    <div class="block-title">
                        ...
                        <h4 style="width: 100%;">
                            ...
                            <div style="float: right;font-size:12px">管控对象风险等级：<span
        ...
        methods: {
            ...
            forwardthree: function (risk, riskc) {
                ...
                $.post(projectName + "/RiskControlMeasureControl/gotothree/" + riskSiteID + "/" + position, function (data) {
                    if (data) {
                        window.location.href = "<%=request.getContextPath()%>/menu/RiskControlMeasure1.action";
                    }
                });
            },
            //子附件下载
