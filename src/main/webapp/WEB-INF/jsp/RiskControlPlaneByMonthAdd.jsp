                ...
                <div id="example-datatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <div class="row" style="background-color: #fff;">
                        <div class="col-sm-12 dib" style="margin: 10px 0px;">
                            <label class="control-label">风险管控计划内容</label>
                        ...
                        <div class="col-sm-12" style="margin: 10px 0px;">
                            <div id="" class="">
                                <form method="post" class="form-horizontal" onsubmit="return false;">
                                    ...
                                    <div class="col-sm-hh">
                                        <label class="control-label" for="example-input-small">专业</label>
                                        <div class="col-sm-hh1">
                ...
                <div style="overflow-y: auto;height: 300px; overflow-x: auto;width: auto"
                    ...
                    <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                        ...
                        <tr v-for="(myplanbymonthitem,index) in planbymonthitem">
                            ...
                            <%-- <td class="text-center" v-text="myplanbymonthitem.mriskSite.riskColor"></td>--%>
                            <td class="text-center" id="riskColor">
                                <span v-if="myplanbymonthitem.mriskSite.riskColor!=null" v-bind:style="'background-color:' + myplanbymonthitem.mriskSite.riskColor" class="btys"></span>
                                <span v-else class="btys"></span>
                            </td>
                            <td class="text-center" v-if="myplanbymonthitem.controlMeasureCount!=0&&myplanbymonthitem.controlMeasureCount!=null"><a @click="updateRiskControlMeasure(myplanbymonthitem.mriskSite)">{{myplanbymonthitem.controlMeasureCount}}</a></td>
                            <td class="text-center" v-if="myplanbymonthitem.controlMeasureCount==0">{{myplanbymonthitem.controlMeasureCount}}</td>
                            ...
                            <td>
                                <row>
                                    <i-col span="12">
                                        <date-picker type="date" v-model="myplanbymonthitem.planStartDate"
                                                     placeholder="请选择管控开始时间" @on-open-change="confirmIndex(index)"
                                                     @on-change="selectStartTime" style="width: 110px"></date-picker>
                                    </i-col>
                                </row>
                            </td>
                            <td>
                                <row>
                                    <i-col span="12">
                                        <date-picker type="date" v-model="myplanbymonthitem.planEndDate"
                                                     placeholder="请选择管控结束时间" @on-open-change="confirmIndex(index)"
                                                     @on-change="selectEndTime" style="width: 110px"></date-picker>
                                    </i-col>
                                </row>
                            </td>
                            <td class="text-center">
                                <i-select
                                        v-model="myplanbymonthitem.mUnits"  <%--@on-change="getCurrOrgEmpList(index)"--%>
...
<script>
    $(document).ready(function () {
        var tadate = new Date();
        if ($("#myyear").val() == "" || $("#myyear").val() == null || $("#mymonth").val() == "" || $("#mymonth").val() == null || $("#myday").val() ==null ||$("#myday").val() =="") {
...
//                        $("#r" + _self.planbymonthitem[i].risksiteID + "").val()
            ...
            showOrNot: function () {
                ...
                }/*else if($("#monthPlanFrequency").val() =="每日") {
                    $("#showX").hide();
                    $("#showZ").hide();
                    $("#showR").hide();
                }*/
            ...
            getUpdateInfo: function () {
                ...
                if ($("#monthPlaneID").val() != "" && $("#monthPlaneID").val() != "null" && $("#monthPlaneID").val() != null) {
                    ...
                    $.get(projectName + "/RiskControlPlaneByMonthControl/getRiskcontrolplanebymonthByID1/" + riskmonthplanID, function (data) {
                        ...
                        var dayValue=_self.riskplanbymonth.monthplanName.substring(0,1);
                        $("#myyear").val(yearValue);
                        $("#mymonth").val(monthValue);
                        $("#myday").val(dayValue);
                        $("#planName").val(_self.riskplanbymonth.monthplanType);
                        if (_self.riskplanbymonth.monthPlanFrequency == "每年" || _self.riskplanbymonth.monthPlanFrequency == "每月" || _self.riskplanbymonth.monthPlanFrequency == "每日") {
...
//                            _self.xunDu = _self.riskplanbymonth.monthPlanFrequency;
                        ...
                        }/*else if(_self.riskplanbymonth.monthPlanFrequency.indexOf('日')!= -1){
                            $("#monthPlanFrequency").val("每日");
                            $("#riDu").val(_self.riskplanbymonth.monthPlanFrequency);
...
//                        $("#monthplanMajorType").val(_self.riskcontrolplanebymonth.monthplanMajorType)
            ...
            addRiskcontrolplanebymonth: function () {
                ...
                _self.riskcontrolplanebymonth.monthplanName = $("#myyear").val() + "-" + $("#mymonth").val() + $("#planName").val() + $("#monthplanMajorType").val() +$("#monthPlanFrequency").val()+ "的风险管控计划";
                if ($("#monthPlanFrequency").val() == "每年" || $("#monthPlanFrequency").val() == "每月" || $("#monthPlanFrequency").val() == "每日") {
...
<script>
    ...
    lay('.datepiccker2').each(function(){
        if($("#monthPlaneID").val() =="" || $("#monthPlaneID").val() =="null"){
            laydate.render({
                elem:this
                ,trigger:'click'
