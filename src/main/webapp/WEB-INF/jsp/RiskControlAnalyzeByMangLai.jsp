...
<div id="page-content" style="min-height: 794px;" onkeydown="search()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select v-model="monthPlanFrequency" name="example-input-small"
                                        ...
                                        type="text">
                                    <option value=null>请选择检查频次</option>
                ...
                <div id="example-datatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                        ...
                        <tr>
                            ...
                            <th class="text-center">管控效果分析</th>
                        ...
                        <tr>
                            ...
                            <td v-text="risksitcontrolanalyzeObject.description"></td>
                            <td
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <i-select type="text" v-model="createUnitName" filterable clearable >
    ...
    <form id="getExcell" action="<%=request.getContextPath()%>/RiskControlAnalyzeControl/getExcellByMangLai" method="post">
    ...
    var vueApp = new Vue({
        ...
        methods: {
            ...
            searchcheckResult: function () {
                var _self = this;
                _self.risksitcontrolanalyze.createunitName=_self.createUnitName;
                _self.getPageCount();
            },
            //获取所有人员
            ...
            gotoNew: function (riskControlPlaneByMonth) {
                ...
                $.post(projectName + "/RiskControlAnalyzeControl/goToNew/" + monthplaneID, {}, function (data) {
                    window.location.href = projectName + "/menu/RiskControlAnalyzeAddByMangLai.action";
                });
            },
            ...
            getNotAnalyzePlane: function () {
                var _self = this;
                $.post(projectName + "/RiskControlAnalyzeControl/getNotAnalyzePlanebyallPlans/" + _self.nowYear + "/" + _self.nowMonth + "/" + _self.monthType + "/" + _self.monthPlanFrequency, {}, function (data) {
            ...
            newObject: function () {
                $.post(projectName + "/RiskControlAnalyzeControl/gotoUpdate/0", function (data) {
                    window.location.href = "<%=request.getContextPath()%>/menu/RiskControlAnalyzeAddByMangLai.action";
                });
            },
            ...
            getPageCount: function () {
                var _self = this;
              //  _self.risksitcontrolanalyze.id = null;
...
<script>
    ...
    function Pop(/*title,url,intro*/) {
        ...
        this.hideTime = 500;
        this.delay = 10000;
        $.post(projectName + "/RiskControlAnalyzeControl/getNotAnalyzePlanes/" + 0 + "/" + 0 + "/" + null + "/" + null, {}, function (data) {
