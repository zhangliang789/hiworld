            ...
            <div class="">
                <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                    <tr class="biaot">
                        ...
                        <td class="text-center" rowspan="2" style="min-width:200px;">风险描述
                        </td>
                        <td class="text-center" rowspan="2">风险类型
                        </td>
                        <td class="text-center" rowspan="2">危害因素
                        </td>
                        <td class="text-center" rowspan="2">风险等级
                        </td>
                        <td class="text-center" rowspan="2">风险颜色
                        </td>
                        <td class="text-center"  style="min-width:20px;">管理属性
                        </td>
                        <td class="text-center" rowspan="2" style="min-width:200px;">管控措施内容
                        </td>
                        <td class="text-center" rowspan="2">管控措施附件
                        </td>
                        <td class="text-center" rowspan="2">技术指导部门
                        </td>
                        <td class="text-center" rowspan="2">监管部门
                        </td>
                        <td class="text-center" rowspan="2">认定日期
                        </td>
                        <td class="text-center" rowspan="2">解除日期
                        </td>
                    ...
                    <tr v-for="(risk,riskIndex) in detailedAllList">
                        ...
                        <td class="text-center" v-text="risk.RiskByTypes">
                        </td>
                        <td class="text-center" v-text="risk.RiskFactors">
                        </td>
