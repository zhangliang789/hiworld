        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="header-section">
                    <h1  style="float: left;">年度辨识维护页面</h1>
        ...
        <div class="table-responsive" style="padding: 0 15px">
            <div id="example-datatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                <div class="row" style="background-color: #fff;">
                    <div class="col-sm-12" style="padding: 0">
                        <div class="form-group" style="float: right;">
                            <button type="submit" class="btn btn-effect-ripple btn-primary" @click="watchInfo" data-toggle="modal"
                                    data-target="#modal-add">选择风险点
                            </button>
                        </div>
                    </div>
                </div>
                <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                        ...
                        <%--<td class="text-center" rowspan="2">可能导致事故原因</td>--%>
                        ...
                        <td class="text-center" rowspan="2" style="width: 50px">操作</td>
                         </tr>
                    <tr>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><i class="fa fa-caret-right fa-fw"></i>
                            <a v-text="risk.name+'('+risk.mchildRiskSite.length+')'" @click="showChild(risk)"></a>
                        </td>
                        ...
                        <td class="text-center">
                            <a href="javascript:void(0)" data-toggle="tooltip" @click="deleperson(riskIndex)">删除</a>
                        </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-sm-12" style="text-align: right;padding:0">
                        <div class="searchCon">
                            ...
                            <input name="search" v-model="checkIDs" id="keywords" placeholder="输入风险点名称 回车查询" class="searchWrap" type="text"></div>
                    </div>
    ...
    var vueApp = new Vue({
        ...
        methods: {
            ...
            checkRisksite: function (riskSite) {
                ...
                if(riskSite.riskColor == null){
                    riskSite.riskColor = "#FFFFFF";
                }
            ...
            deleperson: function (index) {
                var _self = this;
                var tempList = [];
                tempList = _self.riskSitelst;
                _self.riskSitelst = [];
                tempList.splice(index,1);
                _self.riskSitelst = tempList;
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                if(data){
                                    ...
                                    $("AttachmentUUID").val("");
                                    _self.riskSitelst =[];
                                    window.location.href="<%=request.getContextPath()%>/menu/RiskIdentificationByYear.do"
                                } else {
