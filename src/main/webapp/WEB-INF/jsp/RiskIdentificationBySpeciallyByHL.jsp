...
<div id="page-content" style="min-height: 794px;">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="header-section">
                    <h1 style="float: left;">黄陵二矿专项辨识</h1>
    ...
    <form id="getExcell" action="<%=request.getContextPath()%>/RiskIdentificationBySpecially/getExcellByHL" method="post">
    ...
    var vueApp=new Vue({
        ...
        methods:{
            ...
            getDataByPage: function (page) {
                ...
                $.ajax({
                    type: "POST",
                    url: projectName + "/RiskIdentificationBySpecially/PagebyHL",
                    dataType: "json",
                    contentType: "application/json",
                    data: JSON.stringify(_self.newbyspecially),
                    success: function (data) {
            ...
            addspecially:function(){
                ...
                $.post(projectName+"/RiskIdentificationBySpecially/byadd/",function(data){
                    window.location.href="<%=request.getContextPath()%>/menu/RiskIdentificationBySpeciallyEntryByHL.action"
                });
            },
