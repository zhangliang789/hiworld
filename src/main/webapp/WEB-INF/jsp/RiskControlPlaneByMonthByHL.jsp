        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="header-section">
                    <h1 style="float: left;">黄陵二矿安全风险管控计划</h1>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <%--<input class="form-control input-sm" placeholder="" type="text"--%>
                                <%--id="majortype"></div>--%>
                                <i-select v-model="majortype" placeholder="请选择系统"
                                          type="text" clearable filterable>
                                    <i-option value="生产系统">生产系统</i-option>
                                    <i-option value="机电运输系统">机电运输系统</i-option>
                                    <i-option value="一通三防系统">一通三防系统</i-option>
                                    <i-option value="地测防治水">地测防治水</i-option>
                                    <i-option value="监测监控系统">监测监控系统</i-option>
                                    <i-option value="矿井安全生产">矿井安全生产</i-option>
        ...
        methods: {
            ...
            jumpMonthAdd: function () {
                ...
                $.post(projectName + "/RiskControlPlaneByMonthControl/getRiskcontrolplanebymonthByID/-1/0", function (data) {
                    window.location.href = projectName + "/menu/RiskControlPlaneByMonthByHLAdd.action";
                });
