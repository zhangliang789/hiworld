...
<div id="page-content" style="min-height: 794px;" onkeydown="search()">
            ...
            <div class="">
                <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                    <tr class="biaot">
                        ...
                        <td class="text-center" rowspan="2" style="min-width: 200px">风险
                        </td>
                        ...
                        <td class="text-center" rowspan="2">风险值
                        </td>
                       ...
                       <%-- <td class="text-center" rowspan="2" style="min-width: 500px;">管控范围
                        </td>--%>
                    ...
                    <tr v-for="(risk,riskIndex) in detailedAllList">
                        ...
                        <td class="text-center" v-text="risk.TopName">
                        </td>
                        <td class="text-center" v-text="risk.ChildName">
                        </td>
                        <td class="text-center" v-text="risk.HazardName">
                        </td>
                        <%--<td class="text-center" v-text="risk.hazardDesc">--%>
                        <%--</td>--%>
                        <td class="text-center" v-text="risk.HazardMajorType">
                        </td>
                        <td class="text-center" v-text="risk.HazardDamageType">
                        </td>
                        <td class="text-center" v-text="risk.HAccidentType">
                        </td>
                        <td class="text-center" v-text="risk.HazardIdentifyMethod">
                        </td>

                        <td v-if="risk.HazardPossibility==''||risk.HazardPossibility==null||risk.HazardPossibility==0"></td>
                        <td v-if="risk.HazardLossConsequence!=''&&risk.HazardLossConsequence!=0"
                            style="white-space: nowrap">评估方法(LEC): L={{risk.HazardPossibility}} ,
                            E={{risk.HazardExpose}} , C={{risk.HazardLossConsequence}}
                        </td>
                        <td v-if="risk.HazardSseverity!=''&&risk.HazardSseverity!=0"
                            style="white-space: nowrap">评估方法(LS): L={{risk.HazardPossibility}} ,
                            S={{risk.HazardSseverity}}
                        </td>
                       <%-- <td v-if="risk.HazardSseverity!=0&&risk.HazardSseverity!=''" style="white-space: nowrap">
                            评估方法(LS): L={{risk.HazardPossibility}} , S={{risk.HazardSseverity}}
                        </td>--%>
                        ...
                        <td v-text="risk.HazardRiskValue"></td>
                        ...
                        <%--<td class="text-center" v-text="risk.ControlRang">
                        </td>--%>
                ...
                <div class="modal-body" style="height:750px;">
                    ...
                    <form method="post" class="form-horizontal" onsubmit="return false;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control nihao1" placeholder="请输入管控对象名称" type="text" v-model="childName">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">风险描述</label>
                            <div class="col-sm-8">
                                <input class="form-control nihao1" placeholder="请输入风险描述" type="text" v-model="hazardName">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">风险灾害类型</label>
                            <div class="col-sm-8">
                                <i-select v-model="damageType" placeholder="请选择风险灾害类型" type="text" clearable filterable>
                                    <i-option v-for="(mydamage,index) in damageList" :value="mydamage.fData_Name" :label="mydamage.fData_Name">
                                        <span v-text="mydamage.fData_Name"></span>
                                        <span style="float:right;color:#ccc" v-text="mydamage.fData_Name_Shorthand"></span>
                                    </i-option>
                                </i-select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">风险事故类型</label>
                            <div class="col-sm-8">
                                <i-select v-model="accidentType" placeholder="请选择风险事故类型" clearable filterable>
                                    <i-option v-for="(accident,index) in accidentList" :value="accident.fData_Name" :label="accident.fData_Name" :key="index">
                                        <span v-text="accident.fData_Name"></span>
                                        <span style="float:right;color:#ccc" v-text="accident.fData_Name_Shorthand"></span>
                                    </i-option>
                                </i-select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <i-select v-model="majorType" placeholder="请选择风险专业类型" type="text" clearable filterable>
                                    <i-option v-for="(mycategory,index) in categoryList" :value="mycategory.fData_Name" :label="mycategory.fData_Name">
                                        <span v-text="mycategory.fData_Name"></span>
                                        <span style="float:right;color:#ccc" v-text="mycategory.fData_Name_Shorthand"></span>
                                    </i-option>
                                </i-select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input placeholder="请选择管控周期（始）" readonly class="form-control input-sm" type="text" id="startTime"/>
                            </div>
                            <div class="col-sm-4">
                                <input placeholder="请选择管控周期（终）" readonly class="form-control input-sm" type="text" id="endTime"/>
                            </div>
                        </div>
                    </form>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-effect-ripple btn-primary" @click="getRiskDetailByXinAnCount" data-dismiss="modal">确认</button>
    ...
    <form id="getExcell" action="<%=request.getContextPath()%>/Templatehazard/getExcellByXinAn" method="post">
        ...
        <input id="childName" name="childName" type="hidden"/>
...
//            vueApp.topName = keywords;
            vueApp.getRiskDetailByXinAnCount();
        }
    }
...
//        vueApp.topName = keywords;
    ...
    var vueApp = new Vue({
        ...
        created: function () {
            ...
            _self.getRiskDetailByXinAnCount();
        ...
        methods: {
            ...
            getRiskDetailByXinAnCount: function () {
                var _self = this;
                layer.load();
                _self.nowpage = 1;
                ...
                var endTime = $("#endTime").val();
                $.ajax({
                    url: projectName + "/Templatehazard/getRiskDetailByXinAnCount", //发送请求的地址。
                    type: "POST", //(默认: "GET") 请求方式 ("POST" 或 "GET")， 默认为 "GET"。注意：其它 HTTP 请求方法，如 PUT 和 DELETE 也可以使用，但仅部分浏览器支持。
                    data: {
                        "topName": _self.topName,
                        "childName": _self.childName,
                    ...
                    success: function (data) {
                        ...
                        _self.getRiskDetailByXinAn();
                        layer.closeAll('loading');
                    },
                });

            },
            getRiskDetailByXinAn: function () {
                var _self = this;
                layer.load();
                _self.detailedAllList=[];
                var startTime = $("#startTime").val();
                var endTime = $("#endTime").val();
                $.ajax({
                    url: projectName + "/Templatehazard/getRiskDetailByXinAn", //发送请求的地址。
                    type: "POST", //(默认: "GET") 请求方式 ("POST" 或 "GET")， 默认为 "GET"。注意：其它 HTTP 请求方法，如 PUT 和 DELETE 也可以使用，但仅部分浏览器支持。
                    data: {
                        "topName": _self.topName,
                        "childName": _self.childName,
