...
<div id="page-content" style="min-height: 794px;">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="header-section">
                    <h1  style="float:left;margin-bottom: 0;">年度辨识</h1>

                    <div class="form-group" style="float: right;margin-bottom: 0;">
                        <%--<a href="<%=request.getContextPath() %>/menu/RiskIdentificationByYearEntry.do"  class="btn btn-effect-ripple btn-primary">新建</a>--%>
                        <a href="../RiskByYearControl/byid/0" data-toggle="tooltip" class="btn btn-effect-ripple btn-primary">新建</a>

                        <button type="submit" @click="getExcell" class="btn btn-effect-ripple btn-primary">导出</button>
                            <%--附加功能点--%>
                            <a @click="getrisksiteys"> 风险点ResultMap映射下面的风险以及措施</a>
                    </div>
                ...
                <div id="example-datatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 80px">辨识风险点数量</th>
                        ...
                        <tr v-for="(risk,riskIndex) in detailedList">
                            ...
                            <td  v-text="risk.myear" ></td>
                            <td  v-text="risk.meetingTime" ></td>
                            <td  v-text="risk.myearEntry.length"></td>
                            ...
                            <td class="text-center">
                                <a v-bind:href="'../RiskByYearControl/byid/'+ risk.riskidentificationYearID" data-toggle="tooltip"  class="">修改</a>

                                <a  data-toggle="modal" data-target="#Modal-delete"
                                   class="" @click="deleteTask=risk"  >删除</a>
                            </td>
                        </tbody>
                    </table>
                         <div class="row">
    ...
    <form id="getExcell" action="<%=request.getContextPath()%>/RiskByYearControl/getExcell" method="post">
...
<script type="text/javascript">
    ...
    var vueApp = new Vue({
        ...
        methods: {
            ...
            getrisksiteys:function(){
                $.get(projectName + "/RiskByYearControl/getrisksiteys",function(data){
                    var risklist = data;
            ...
            getPageCount: function () {
                var _self = this;
                _self.Riskidentbyyear.pagesize = _self.pagesize;
                $.ajax({
                    type: "POST",
                    url: projectName + "/RiskByYearControl/PageCount",
                    dataType: "json",
                    contentType: "application/json",
                    data: JSON.stringify(_self.Riskidentbyyear),
                    success: function (data) {
                        if (data > 0) {
                            if (data == 1) {
                                $("#pagination").hide();
            ...
            getDataByPage: function (page) {
                var _self = this;
                _self.Riskidentbyyear.page = page;
                $.ajax({
                    type: "POST",
                    url: projectName + "/RiskByYearControl/Page",
                    dataType: "json",
                    contentType: "application/json",
                    data: JSON.stringify(_self.Riskidentbyyear),
                    success: function (data) {
            ...
            confirmDelete: function () {
                ...
                $.ajax({
                    type: "DELETE",
                    url: projectName + "/RiskByYearControl/delete",
                    dataType: "json",
                    contentType: "application/json",
