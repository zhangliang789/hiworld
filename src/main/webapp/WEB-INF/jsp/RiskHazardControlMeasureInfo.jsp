                ...
                <div>
                    ...
                    <table id="general-table"
                        ...
                        <tr class="biaot biaot1">
                            ...
                            <td class="text-center" rowspan="2" style="width: 25%" v-show="showOrNot('hazardDesc')">
    ...
    var vueApp = new Vue({
        ...
        methods: {
            ...
            getHazardByID: function () {
                var _self = this;
                $.post(projectName + "/RiskControlMeasureControl/getHazardInfo", function (data) {
                    _self.riskHazards.push(data);
                });
            },
            //修改管控措施
