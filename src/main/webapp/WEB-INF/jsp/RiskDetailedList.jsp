            ...
            <div class="">
                <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                    <tr class="biaot">
                        ...
                        -->
                        <td class="text-center" rowspan="2">风险等级及数量
                        </td>
                        ...
                        <tr v-for="(risk,riskIndex) in detailedList">
                            ...
                            --%>
                            <td v-text="risk.childRiskCount" style="width: 250px"></td>
                    ...
                    <form method="post" class="form-horizontal" onsubmit="return false;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <i-select v-model="riskSite.riskDamageType" placeholder="请选择风险灾害类型"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <i-select v-model="riskSite.riskMajorType"  placeholder="请选择风险专业类型"
                                          type="text" clearable filterable>
...
<script type="text/javascript">
    ...
    function searchRiskSite() {
        vueApp.riskSite.riskControlTier = $("#riskControlTier").val();
        vueApp.riskSite.riskDamageType = $("#riskDamageType").val();
        vueApp.riskSite.riskLevel = $("#riskLevel").val();
        vueApp.riskSite.riskMajorType = $("#riskMajorType").val();
        vueApp.riskSite.name = $("#riskSiteName").val();
        vueApp.getPageCount();
    }
    ...
    var vueApp = new Vue({
        ...
        methods: {
            ...
            getExcell:function(){
                ...
                $("#riskLevelSettingID").val(_self.riskSite.riskLevelSettingID);
            ...
            forwardMRiskSite: function (risk) {
                ...
                var page = _self.nowpage;
                $.post(projectName + "/RiskControlMeasureControl/gotoMRiskSite/" + riskSiteID + "/" + position,function (data) {
                    if (data) {
                        location.href = "<%=request.getContextPath()%>/menu/RiskDetailedListShowMRiskSite.action?page=" + page;
                    }
                });
                    ...
                    success: function (data) {
                        ...
                        if (data > 0) {
                            ...
                            if (<%=request.getParameter("page")%>){
                                ...
                                _self.getDataByPage(<%=request.getParameter("page")%>);
                                //控制序号
                                _self.nowpage = <%=request.getParameter("page")%>;
                                console.log(_self.nowpage);
                                _self.getDataByPage(<%=request.getParameter("page")%>);
                            }
                            else{
