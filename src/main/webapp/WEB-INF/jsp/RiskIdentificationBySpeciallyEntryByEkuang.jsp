        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="header-section">
                    <h1 style="float:left;">专项辨识维护页面</h1>
    ...
    <div class="block full">
        <div class="table-responsive" style="border-bottom: 2px solid rgb(225, 225, 225);">
            <div id="example-datatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                <div  v-if="showSpecialName == true" class="row" style="background-color: #fff;">
                    <div class="col-sm-12">
                        <div id="" class="">
                            <form method="post" class="form-inline" onsubmit="return false;">
                                <div class="form-group">
                                    <label class="" for="example-if-password">专项辨识名称</label>
                            ...
                            <form method="post" class="form-horizontal" onsubmit="return false;">
                                <div class="col-sm-hh">
                                    ...
                                    <div class="col-sm-hh1">
                                        <input type="text" id="specialName" name="example-input-small"
            ...
            <div id="example-datatable_wrappe" class="dataTables_wrapper form-inline no-footer">
                ...
                <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                    ...
                    <tr v-for="(riskc,index) in risk.mchildRiskSite" v-show="risk.showChild"
                        ...
                        <%--<td>{{riskc.mriskControlMeasure.length}}</td>--%>
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="min-height: 100%">
                    <div class="modal-body">
                        ...
                        <table id="gener" class="table table-striped table-bordered table-vcenter table-hover">
                            ...
                            <tr v-for="(rcm,index) in detailedList">
                                ...
                                <%--<label class="csscheckbox csscheckbox-primary">--%>
                                <%--<input class="select1" type="radio"  @click="checkRisksite(rcm,index)" id="index" name="chkItem" >--%>
                                <%--<span></span>--%>
                                <%--</label>--%>
                                <%--</td>--%>
                                ...
                                <%--class="btn btn-effect-ripple btn-sm btn-danger" @click="deleperson(index)" title="删除">--%>
                    ...
                    <div class="modal-footer">没找到？请去<-风险辨识界面->添加风险点
                        ...
                        <%--<a  class="btn btn-effect-ripple btn-primary"--%>
                        <%--href="<%=request.getContextPath() %>/menu/HazardIdentification.do" >添加风险点</a>--%>
...
<script>
    $(document).ready(function () {
        ...
        if ($("#identificationYear").val() == "" || $("#identificationYear").val() == null || $("#IdentificationMonth").val() == "" || $("#IdentificationMonth").val() == null) {
            ...
            if(mouth<10){
                $("#IdentificationMonth").val(tadate.getFullYear()+"-0" + mouth+"-"+date);
            }else{
                $("#IdentificationMonth").val(tadate.getFullYear()+"-"+mouth+"-"+date);
...
//               },
            ...
            addtaks: function (data) {
                ...
                if(_self.showSpecialName == true){
                    _self.riskidBySpecially.specialName = $("#specialName").val();
                }
                ...
                if(_self.showSpecialName == true && $("#specialName").val() == ''){
                    _self.showToast("warning","请添加专项辨识名称");
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data) {
                            ...
                            $("#AttachmentUUID").val("");
                            _self.riskSitelst = [];
                            window.location.href="<%=request.getContextPath()%>/menu/RiskIdentificationBySpecially.do"
                        } else {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data != false){
                            ...
                            if(_self.showSpecialName == true){
                                $("#specialName").val(data.specialName);
                            }
