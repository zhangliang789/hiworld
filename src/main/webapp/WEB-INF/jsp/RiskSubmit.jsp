        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="header-section" style="overflow: hidden;">
                    <h1 style="float: left;padding:0">风险管控清单上报</h1>
                    ...
                    <div style="float: right;padding:0">
                        ...
                        <button type="button" @click="submitCheckedRist" class="btn btn-effect-ripple btn-primary">上报
                        </button>
                    </div>
                ...
                <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                    ...
                    <tr v-for="(risk,riskIndex) in detailedAllList">
                        <td class="text-center">
                            <input type="checkbox" :value="{id:risk.HazardID}" v-model="checkedIds"/>
                        </td>
                    ...
                    <form method="post" class="form-horizontal" onsubmit="return false;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <i-select v-model="damageType" placeholder="请选择风险灾害类型"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <%--<input class="form-control input-sm" placeholder="" type="text"--%>
                                <%--v-model="riskSite.riskDamageType">--%>
                                <i-select v-model="accidentType" placeholder="请选择风险事故类型"
                                          clearable filterable>
                                    <%--<option value=null>请选择灾害类型</option>--%>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <%----%>
                                <i-select placeholder="请选择风险点等级" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <i-select v-model="majorType" placeholder="请选择风险专业类型"
                                          type="text" clearable filterable>
...
//        vueApp.topName = keywords;
    ...
    var vueApp = new Vue({
        ...
        methods: {
            /*上报风险*/
            submitCheckedRist: function () {
                var $this = this;
                if (this.checkedIds.length == 0) {
                    return;
                }
                var ids = this.checkedIds.map(function (i) {
                    return i.id;
                }).join(",");
                $.post(projectName + '/risk/submit', {ids: ids + ","}, function (result) {
                    $this.getRiskDetailByXinAnCount();
                    $this.checkedIds = [];
                    $this.showToast("success", "上报成功");
                }, 'json')
            },
            ...
            getRiskDetailByXinAnCount: function () {
                ...
                var endTime = $("#endTime").val();
                $.ajax({
                    url: projectName + "/risk/getRiskSubmitCount", //发送请求的地址。
                    type: "POST", //(默认: "GET") 请求方式 ("POST" 或 "GET")， 默认为 "GET"。注意：其它 HTTP 请求方法，如 PUT 和 DELETE 也可以使用，但仅部分浏览器支持。
                    data: {
                        "search_topName": _self.topName,
                        "search_majorType": _self.majorType,
                        "search_damageType": _self.damageType,
                        "search_riskLevelSettingID": _self.riskLevelSettingID,
                        "search_accidentType": _self.accidentType,
            ...
            getRiskDetailByXinAn: function () {
                ...
                var endTime = $("#endTime").val();
                $.ajax({
                    url: projectName + "/risk/getUnSubmitRiskList", //发送请求的地址。
                    type: "POST", //(默认: "GET") 请求方式 ("POST" 或 "GET")， 默认为 "GET"。注意：其它 HTTP 请求方法，如 PUT 和 DELETE 也可以使用，但仅部分浏览器支持。
                    data: {
                        "search_topName": _self.topName,
                        "search_majorType": _self.majorType,
