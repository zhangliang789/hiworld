                                ...
                                <div style="float: right;">
                                    <template>
                                        <Page :total="detailedListAll.length" :current.sync="nowpage"
                                              @on-change="changePage" :page-size="pagesize"></Page>
                                    </template>
                                </div>
                            </div>
                        </Tab-pane>
...
<script>
    ...
    },
    {
        ...
        // var riskSiteID ="21,22,23,27,28,29,30";
        var riskSiteID = params.row.HazardID;
        ...
        h('Button', {
            ...
            on: {
                ...
                console.log(params.row);
        var _this = this;
        var HazardID = params.row.HazardID;
        var hazardName = params.row.HazardName;
        $.post("../Riskcontrolhistory/gotohistoryDetail/" + HazardID + "/" + hazardName, function (data) {
            window.location.href = "../menu/RiskcontrolhistoryDetail.do";
        });
