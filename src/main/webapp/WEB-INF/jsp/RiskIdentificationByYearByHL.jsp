        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="header-section">
                    <h1  style="float:left;margin-bottom: 0;">黄陵二矿年度辨识</h1>
                    ...
                    <div class="form-group" style="float: right;margin-bottom: 0;">
                        ...
                        <a href="../RiskByYearControl/byHLid/0" data-toggle="tooltip" class="btn btn-effect-ripple btn-primary">新建</a>
                    ...
                    <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                        ...
                        <tr v-for="(risk,riskIndex) in detailedList">
                            ...
                            <td class="text-center">
                                <a v-bind:href="'../RiskByYearControl/byHLid/'+ risk.riskidentificationYearID" data-toggle="tooltip"  class="">修改</a>
