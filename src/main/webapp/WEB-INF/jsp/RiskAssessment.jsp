...
<div id="page-content" style="min-height: 794px;" onkeydown="search()">
            ...
            <div class="">
                <table id="general-table" class="table table-striped table-bordered table-vcenter table-hover">
                    <tr class="biaot">
                        ...
                        <td class="text-center" rowspan="2" v-show="showOrNot('Name')">{{'Name'|titleFilter('风险点')}}
                        </td>
                       ...
                       <%-- <td class="text-center" rowspan="2" v-show="showOrNot('RiskAccident')">事故类型</td>--%>
                        ...
                        <tr>
                            ...
                            <td v-show="showOrNot('Name')" style="white-space: nowrap">
            ...
            <div class="modal-content" style="min-height: 100%">
                <div class="modal-body">
                    ...
                    <div class="block-title">
                        <h4 style="width: 100%;">
                            <span>风险点：{{updateRiskSite.name}}</span>
                            <%--<span>({{updateRiskSite.riskMajorType}})</span>--%>
                            <div style="float: right;font-size:12px">风险点等级：
                ...
                <div class="modal-body" style="height:851px;">
                    ...
                    <form method="post" class="form-horizontal" onsubmit="return false;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control nihao1" placeholder="" type="text" v-model="riskSite.name">
                            </div>
                        </div>
                        <%--<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <i-select v-model="riskSite.riskDamageType" placeholder="请选择灾害类型"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <i-select placeholder="请选择风险等级" type="text"
                                          v-model="riskSite.riskLevelSettingID" clearable filterable>
                        ...
                        <%--<div class="form-group">--%>
                            ...
                            <%--<div class="col-sm-8">--%>
                                ...
                                <%--<i-select v-model="riskSite.riskMajorType" placeholder="请选择专业类型"--%>
                                          <%--type="text" clearable filterable>--%>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">风险点描述</label>
                            <div class="col-sm-8">
                                <input class="form-control input-sm" placeholder="" type="text" v-model="riskSite.riskDescription"/>
                            </div>
                        </div>
                    </form>
                    <div class="modal-footer">
    ...
    <form id="getExcell" action="<%=request.getContextPath()%>/Security_risk_assessment/getExcell" method="post">
        ...
        <input id="riskDescription" name="riskDescription" type="hidden" />
    </form>
</div>
    ...
    var vueApp = new Vue({
        ...
        methods: {
            ...
            getExcell: function () {
                ...
                $("#riskDescription").val(_self.riskSite.riskDescription);
                $("#getExcell").submit();
            },
            //筛选矿关闭时还原原本数据
            clearData: function () {
            ...
            judgeQuery: function () {
                ...
                if(_self.riskSite.riskDescription =='null'){
                    _self.riskSite.riskDescription =null;
                }
                _self.getPageCount();
            ...
            getAssessmentRiskSite: function (myRiskSite) {
                ...
                _self.updateRiskSite.limitPeopleCount = parseInt($("#peopleCount").val());
                $.ajax({
                    url: projectName + "/RiskAssessment/updateRisksite", //发送请求的地址。
                    type: "POST", //(默认: "GET") 请求方式 ("POST" 或 "GET")， 默认为 "GET"。注意：其它 HTTP 请求方法，如 PUT 和 DELETE 也可以使用，但仅部分浏览器支持。
                    dataType: "json",//预期服务器返回的数据类型。
                    contentType: "application/json",
                    data: JSON.stringify(myRiskSite),//发送到服务器的数据。将自动转换为请求字符串格式。GET 请求中将附加在 URL 后。
                    async: "false",//(默认: true) 默认设置下，所有请求均为异步请求。如果需要发送同步请求，请将此选项设置为 false。注意，同步请求将锁住浏览器，用户其它操作必须等待请求完成才可以执行。
                    success: function (data) {
                        //请求成功后的回调函数
