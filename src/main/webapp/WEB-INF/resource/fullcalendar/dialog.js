        ...
        function(t) {
            return function(t) {
                ...
                function(t, e, o) {
                    function r() {
                        this.destroyed = !1,
                            this.__popup = i("<div />").css({
                                display: "none",
                                position: "absolute",
                                outline: 0
                            }).attr("tabindex", "-1").html(this.innerHTML).appendTo("body"),
                            this.__backdrop = this.__mask = i("<div />").css({
                                opacity: .7,
                                background: "#000"
                            }),
                    ...
                    i.extend(r.prototype, {
                        ...
                        show: function(t) {
                            ...
                            if (this.__activeElement = this.__getActive(), this.open = !0, this.follow = t || this.follow, !this.__ready) {
                                if (e.addClass(this.className).attr("role", this.modal ? "alertdialog": "dialog").css("position", this.fixed ? "fixed": "absolute"), a || i(window).on("resize", i.proxy(this.reset, this)), this.modal) {
                                    ...
                                    e.addClass(this.className + "-modal"),
                                    u || i.extend(n, {
                                        position: "absolute",
                                        ...
                                        this.__mask = o.clone(!0).attr("style", "").insertAfter(e),
                                        o.addClass(this.className + "-backdrop").insertBefore(e),
                                        this.__ready = !0
                                }
                                e.html() || e.html(this.innerHTML)
                            }
                            return e.addClass(this.className + "-show").show(),
                                o.show(),
                                this.reset().focus(),
                        ...
                        close: function(t) {
                            return ! this.destroyed && this.open && (void 0 !== t && (this.returnValue = t), this.__popup.hide().removeClass(this.className + "-show"), this.__backdrop.hide(), this.open = !1, this.blur(), this.__dispatchEvent("close")),
                                this
                        },
                        remove: function() {
                            if (this.destroyed) return this;
                            ...
                            r.current === this && (r.current = null),
                                ...
                                this.__mask.remove(),
                            a || i(window).off("resize", this.reset),
                        ...
                        focus: function() {
                            ...
                            if (o && o !== this && o.blur(!1), !i.contains(t, this.__getActive())) {
                                var a = e.find("[autofocus]")[0]; ! this._autofocus && a ? this._autofocus = !0 : a = t,
                                    this.__focus(a)
                            }
                            return e.css("zIndex", n),
                                r.current = this,
                                e.addClass(this.className + "-focus"),
                                this.__dispatchEvent("focus"),
                                this
                        },
                        blur: function() {
                            var t = this.__activeElement;
                            return arguments[0] !== !1 && this.__focus(t),
                                this._autofocus = !1,
                        ...
                        __center: function() {
                            var t = this.__popup,
                                ...
                                h = 382 * (s - l) / 1e3 + a,
                                c = t[0].style;
                            c.left = Math.max(parseInt(p), n) + "px",
                                c.top = Math.max(parseInt(h), a) + "px"
                        },
                        __follow: function(t) {
                            ...
                            i.each(T,
                                function(t, e) {
                                    S[t][e] > I[P[e]][1] && (e = T[t] = B[e]),
                                    S[t][e] < I[P[e]][0] && (T[t] = B[e])
                                }),
                            T[1] || (P[T[1]] = "left" === P[T[0]] ? "top": "left", S[1][T[1]] = L[P[T[1]]]),
                                U += T.join("-") + " " + this.className + "-follow",
                                n.__followSkin = U,
                            e && o.addClass(U),
                                R[P[T[0]]] = parseInt(S[0][T[0]]),
                                R[P[T[1]]] = parseInt(S[1][T[1]]),
                                o.css(R)
                        },
                        __offset: function(t) {
                            var e = t.parentNode,
                ...
                function(t, e, o) {
                    ...
                    var r = o(0),
                        ...
                        p = function(t, e, o) {
                            ...
                            var n = t.id = t.id || u + a,
                                s = p.get(n);
                            return s ? s.focus() : (l || (t.fixed = !1), t.quickClose && (t.modal = !0, t.backdropOpacity = 0), r.isArray(t.button) || (t.button = []), void 0 !== o && (t.cancel = o), t.cancel && t.button.push({
                                id: "cancel",
                                value: t.cancelValue,
                                callback: t.cancel,
                    ...
                    p.create = function(t) {
                        ...
                        t.quickClose && n.on("onmousedown" in document ? "mousedown": "click",
                            function() {
                                return e._trigger("cancel"),
                                    !1
                            }),
                            ...
                            this._esc = function(t) {
                                var o = t.target,
                                    ...
                                    n = /^input|textarea$/i,
                                    a = i.current === e,
                                    u = t.keyCode; ! a || n.test(r) && "button" !== o.type || 27 === u && e._trigger("cancel")
                            },
                            r(document).on("keydown", this._esc),
                            this.addEventListener("remove",
                                function() {
                                    r(document).off("keydown", this._esc),
                        ...
                        p.create.prototype = c,
                        r.extend(c, {
                            content: function(t) {
                                var e = this._$("content");
                                return "object" == typeof t ? (t = r(t), e.empty("").append(t.show()), this.addEventListener("beforeremove",
                                    function() {
                            ...
                            button: function(t) {
                                ...
                                return this.callbacks = {},
                                    "string" == typeof t ? (o = t, i++) : r.each(t,
                                        function(t, n) {
                                            var a = n.id = n.id || n.value,
                                                u = "";
                                            e.callbacks[a] = n.callback,
                                                n.display === !1 ? u = ' style="display:none"': i++,
                                                o += '<button type="button" i-id="' + a + '"' + u + (n.disabled ? " disabled": "") + (n.autofocus ? ' autofocus class="ui-dialog-autofocus"': "") + ">" + n.value + "</button>",
                                                e._$("button").on("click", "[i-id=" + a + "]",
                                                    function(t) {
                                                        r(this).attr("disabled") || e._trigger(a),
                                                            t.preventDefault()
                                                    })
                                        }),
                                    this._$("button").html(o),
                                    this._$("footer")[i ? "show": "hide"](),
                                    this
                            },
                ...
                function(t, e, o) {
                    ...
                    function i(t) {
                        for (var e = [], o = {},
                            ...
                            o[n] ? o[n].parts.push(f) : e.push(o[n] = {
                                id: n,
                                parts: [f]
                            })
                        }
                    ...
                    function n(t, e) {
                        ...
                        var r = m[m.length - 1];
                        if ("top" === t.insertAt) r ? r.nextSibling ? o.insertBefore(e, r.nextSibling) : o.appendChild(e) : o.insertBefore(e, o.firstChild),
                            m.push(e);
                        else {
                    ...
                    function l(t, e) {
                        ...
                        if (e.singleton) {
                            ...
                            o = v || (v = u(e)),
                                r = p.bind(null, o, n, !1),
                                i = p.bind(null, o, n, !0)
                        } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (o = s(e), r = c.bind(null, o, e), i = function() {
                            a(o),
                            o.href && URL.revokeObjectURL(o.href)
                        }) : (o = u(e), r = h.bind(null, o), i = function() {
                            a(o)
                        });
                        return r(t),
                            function(e) {
                    ...
                    function p(t, e, o, r) {
                        ...
                        if (t.styleSheet) t.styleSheet.cssText = x(e, i);
                            ...
                            a[e] && t.removeChild(a[e]),
                                a.length ? t.insertBefore(n, a[e]) : t.appendChild(n)
                        }
                    }
                    function h(t, e) {
                        var o = e.css,
                    ...
                    function c(t, e, o) {
                        var r = o.css,
                            i = o.sourceMap,
                            n = void 0 === e.convertToAbsoluteUrls && i; (e.convertToAbsoluteUrls || n) && (r = _(r)),
                    ...
                    var d = {},
                        ...
                        w = function(t) {
                            var e = {};
                            return function(o) {
                                return void 0 === e[o] && (e[o] = t.call(this, o)),
                                    e[o]
                            }
                        } (function(t) {
                    ...
                    t.exports = function(t, e) {
                        ...
                        void 0 === e.singleton && (e.singleton = b()),
                ...
                function(t, e, o) {
                    ...
                    function n(t) {
                        ...
                        a = r(t),
                            ...
                            i = a > 0 ? s - 4 : s;
                        var f = 0;
                        for (e = 0, o = 0; e < i; e += 4, o += 3) n = l[t.charCodeAt(e)] << 18 | l[t.charCodeAt(e + 1)] << 12 | l[t.charCodeAt(e + 2)] << 6 | l[t.charCodeAt(e + 3)],
                            u[f++] = n >> 16 & 255,
                            u[f++] = n >> 8 & 255,
                            u[f++] = 255 & n;
                        return 2 === a ? (n = l[t.charCodeAt(e)] << 2 | l[t.charCodeAt(e + 1)] >> 4, u[f++] = 255 & n) : 1 === a && (n = l[t.charCodeAt(e)] << 10 | l[t.charCodeAt(e + 1)] << 4 | l[t.charCodeAt(e + 2)] >> 2, u[f++] = n >> 8 & 255, u[f++] = 255 & n),
                            u
                    }
                    function a(t) {
                    ...
                    function u(t, e, o) {
                        for (var r, i = [], n = e; n < o; n += 3) r = (t[n] << 16) + (t[n + 1] << 8) + t[n + 2],
                            i.push(a(r));
                        return i.join("")
                    }
                    function s(t) {
                        for (var e, o = t.length,
                                 r = o % 3,
                                 i = "",
                                 n = [], a = 16383, s = 0, l = o - r; s < l; s += a) n.push(u(t, s, s + a > l ? l: s + a));
                        return 1 === r ? (e = t[o - 1], i += f[e >> 2], i += f[e << 4 & 63], i += "==") : 2 === r && (e = (t[o - 2] << 8) + t[o - 1], i += f[e >> 10], i += f[e >> 4 & 63], i += f[e << 2 & 63], i += "="),
                            n.push(i),
                            n.join("")
                    }
                    e.byteLength = i,
                        e.toByteArray = n,
                        e.fromByteArray = s;
                    for (var f = [], l = [], p = "undefined" != typeof Uint8Array ? Uint8Array: Array, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", c = 0, d = h.length; c < d; ++c) f[c] = h[c],
                        l[h.charCodeAt(c)] = c;
                    l["-".charCodeAt(0)] = 62,
                        l["_".charCodeAt(0)] = 63
                },
                ...
                function(t, e, o) {
                    "use strict"; (function(t) {
                        ...
                        function f(t, e, o, r) {
                            return s(e),
                                e <= 0 ? n(t, e) : void 0 !== o ? "string" == typeof r ? n(t, e).fill(o, r) : n(t, e).fill(o) : n(t, e)
                        }
                        function l(t, e) {
                            if (s(e), t = n(t, e < 0 ? 0 : 0 | g(e)), !a.TYPED_ARRAY_SUPPORT) for (var o = 0; o < e; ++o) t[o] = 0;
                            return t
                        }
                        function p(t, e, o) {
                        ...
                        function c(t, e, o, r) {
                            ...
                            return e = void 0 === o && void 0 === r ? new Uint8Array(e) : void 0 === r ? new Uint8Array(e, o) : new Uint8Array(e, o, r),
                        ...
                        function d(t, e) {
                            if (a.isBuffer(e)) {
                                var o = 0 | g(e.length);
                                return t = n(t, o),
                                    0 === t.length ? t: (e.copy(t, 0, 0, o), t)
                            }
                            if (e) {
                                if ("undefined" != typeof ArrayBuffer && e.buffer instanceof ArrayBuffer || "length" in e) return "number" != typeof e.length || X(e.length) ? n(t, 0) : h(t, e);
                        ...
                        function m(t, e, o, r, i) {
                            ...
                            if ("number" == typeof e) return e &= 255,
                                a.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? i ? Uint8Array.prototype.indexOf.call(t, e, o) : Uint8Array.prototype.lastIndexOf.call(t, e, o) : _(t, [e], o, r, i);
                        ...
                        function _(t, e, o, r, i) {
                            ...
                            if (i) {
                                var l = -1;
                                for (f = o; f < u; f++) if (n(t, f) === n(e, l === -1 ? 0 : f - l)) {
                                    if (l === -1 && (l = f), f - l + 1 === s) return l * a
                                } else l !== -1 && (f -= f - l),
                                    l = -1
                            } else for (o + s > u && (o = u - s), f = o; f >= 0; f--) {
                                for (var p = !0,
                                         h = 0; h < s; h++) if (n(t, f + h) !== n(e, h)) {
                                    p = !1;
                                    break
                                }
                                if (p) return f
                            ...
                            for (var r = [], i = e; i < o;) {
                                ...
                                if (i + u <= o) {
                                    ...
                                    switch (u) {
                                        ...
                                        case 2:
                                            s = t[i + 1],
                                            128 == (192 & s) && (p = (31 & n) << 6 | 63 & s) > 127 && (a = p);
                                            break;
                                        case 3:
                                            s = t[i + 1],
                                                f = t[i + 2],
                                            128 == (192 & s) && 128 == (192 & f) && (p = (15 & n) << 12 | (63 & s) << 6 | 63 & f) > 2047 && (p < 55296 || p > 57343) && (a = p);
                                            break;
                                        case 4:
                                            s = t[i + 1],
                                                f = t[i + 2],
                                                l = t[i + 3],
                                            128 == (192 & s) && 128 == (192 & f) && 128 == (192 & l) && (p = (15 & n) << 18 | (63 & s) << 12 | (63 & f) << 6 | 63 & l) > 65535 && p < 1114112 && (a = p)
                                    }
                                }
                        ...
                        function P(t) {
                            ...
                            for (var o = "",
                                     r = 0; r < e;) o += String.fromCharCode.apply(String, t.slice(r, r += tt));
                            return o
                        }
                        function S(t, e, o) {
                            var r = "";
                        ...
                        function Y(t, e, o, r) {
                            e < 0 && (e = 65535 + e + 1);
                            for (var i = 0,
                                     n = Math.min(t.length - o, 2); i < n; ++i) t[o + i] = (e & 255 << 8 * (r ? i: 1 - i)) >>> 8 * (r ? i: 1 - i)
                        }
                        function N(t, e, o, r) {
                            e < 0 && (e = 4294967295 + e + 1);
                            for (var i = 0,
                                     n = Math.min(t.length - o, 4); i < n; ++i) t[o + i] = e >>> 8 * (r ? i: 3 - i) & 255
                        }
                        ...
                        function j(t, e, o, r, i) {
                            return i || D(t, e, o, 4, 3.4028234663852886e38, -3.4028234663852886e38),
                                Z.write(t, e, o, r, 23, 4),
                            o + 4
                        }
                        function z(t, e, o, r, i) {
                            return i || D(t, e, o, 8, 1.7976931348623157e308, -1.7976931348623157e308),
                                Z.write(t, e, o, r, 52, 8),
                            o + 8
                        }
                        function $(t) {
                        ...
                        function q(t, e) {
                            ...
                            for (var o, r = t.length,
                                ...
                                if ((o = t.charCodeAt(a)) > 55295 && o < 57344) {
                                    if (!i) {
                                        if (o > 56319) { (e -= 3) > -1 && n.push(239, 191, 189);
                                            continue
                                        }
                                        if (a + 1 === r) { (e -= 3) > -1 && n.push(239, 191, 189);
                                            continue
                                        }
                                        i = o;
                                        continue
                                    }
                                    if (o < 56320) { (e -= 3) > -1 && n.push(239, 191, 189),
                                        i = o;
                                        continue
                                    }
                        ...
                        function J(t, e) {
                            for (var o, r, i, n = [], a = 0; a < t.length && !((e -= 2) < 0); ++a) o = t.charCodeAt(a),
                                r = o >> 8,
                                i = o % 256,
                                n.push(i),
                                n.push(r);
             ...
             */
                        ...
                        a.TYPED_ARRAY_SUPPORT && (a.prototype.__proto__ = Uint8Array.prototype, a.__proto__ = Uint8Array, "undefined" != typeof Symbol && Symbol.species && a[Symbol.species] === a && Object.defineProperty(a, Symbol.species, {
                            ...
                            a.compare = function(t, e) {
                                ...
                                for (var o = t.length,
                                         r = e.length,
                                         i = 0,
                                         n = Math.min(o, r); i < n; ++i) if (t[i] !== e[i]) {
                                    o = t[i],
                                        r = e[i];
                                    break
                                }
                            ...
                            a.prototype.inspect = function() {
                                ...
                                return this.length > 0 && (t = this.toString("hex", 0, o).match(/.{2}/g).join(" "), this.length > o && (t += " ... ")),
                                "<Buffer " + t + ">"
                            },
                            a.prototype.compare = function(t, e, o, r, i) {
                                ...
                                for (var n = i - r,
                                         u = o - e,
                                         s = Math.min(n, u), f = this.slice(r, i), l = t.slice(e, o), p = 0; p < s; ++p) if (f[p] !== l[p]) {
                                    n = f[p],
                                        u = l[p];
                                    break
                                }
                            ...
                            a.prototype.write = function(t, e, o, r) {
                                if (void 0 === e) r = "utf8",
                                    o = this.length,
                                    e = 0;
                                else if (void 0 === o && "string" == typeof e) r = e,
                                    o = this.length,
                                    e = 0;
                                else {
                                    if (!isFinite(e)) throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");
                                    e |= 0,
                                        isFinite(o) ? (o |= 0, void 0 === r && (r = "utf8")) : (r = o, o = void 0)
                                }
                                var i = this.length - e;
                        ...
                        a.prototype.slice = function(t, e) {
                            ...
                            e < t && (e = t);
                            var r;
                            if (a.TYPED_ARRAY_SUPPORT) r = this.subarray(t, e),
                            ...
                            a.prototype.readIntBE = function(t, e, o) {
                                ...
                                for (var r = e,
                                         i = 1,
                                         n = this[t + --r]; r > 0 && (i *= 256);) n += this[t + --r] * i;
                                return i *= 128,
                            ...
                            a.prototype.writeUIntLE = function(t, e, o, r) {
                                if (t = +t, e |= 0, o |= 0, !r) {
                                    M(this, t, e, o, Math.pow(2, 8 * o) - 1, 0)
                                }
                                var i = 1,
                                    n = 0;
                            ...
                            a.prototype.writeUInt16LE = function(t, e, o) {
                                return t = +t,
                                    e |= 0,
                                o || M(this, t, e, 2, 65535, 0),
                                    a.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : Y(this, t, e, !0),
                                e + 2
                            },
                            a.prototype.writeUInt16BE = function(t, e, o) {
                                return t = +t,
                                    e |= 0,
                                o || M(this, t, e, 2, 65535, 0),
                                    a.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : Y(this, t, e, !1),
                                e + 2
                            },
                            a.prototype.writeUInt32LE = function(t, e, o) {
                                return t = +t,
                                    e |= 0,
                                o || M(this, t, e, 4, 4294967295, 0),
                                    a.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : N(this, t, e, !0),
                                e + 4
                            },
                            a.prototype.writeUInt32BE = function(t, e, o) {
                                return t = +t,
                                    e |= 0,
                                o || M(this, t, e, 4, 4294967295, 0),
                                    a.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : N(this, t, e, !1),
                                e + 4
                            },
                            a.prototype.writeIntLE = function(t, e, o, r) {
                                ...
                                var n = 0,
                                    a = 1,
                                    u = 0;
                                for (this[e] = 255 & t; ++n < o && (a *= 256);) t < 0 && 0 === u && 0 !== this[e + n - 1] && (u = 1),
                                    this[e + n] = (t / a >> 0) - u & 255;
                                return e + o
                            },
                            a.prototype.writeIntBE = function(t, e, o, r) {
                                ...
                                var n = o - 1,
                                    a = 1,
                                    u = 0;
                                for (this[e + n] = 255 & t; --n >= 0 && (a *= 256);) t < 0 && 0 === u && 0 !== this[e + n + 1] && (u = 1),
                                    this[e + n] = (t / a >> 0) - u & 255;
                                return e + o
                            },
                            ...
                            a.prototype.writeInt32LE = function(t, e, o) {
                                return t = +t,
                                    e |= 0,
                                o || M(this, t, e, 4, 2147483647, -2147483648),
                                    a.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : N(this, t, e, !0),
                                e + 4
                            },
                            ...
                            a.prototype.copy = function(t, e, o, r) {
                                ...
                                t.length - e < r - o && (r = t.length - e + o);
                                var i, n = r - o;
                                if (this === t && o < e && e < r) for (i = n - 1; i >= 0; --i) t[i + e] = this[i + o];
                                else if (n < 1e3 || !a.TYPED_ARRAY_SUPPORT) for (i = 0; i < n; ++i) t[i + e] = this[i + o];
                            ...
                            a.prototype.fill = function(t, e, o, r) {
                                ...
                                t || (t = 0);
                                var n;
                                if ("number" == typeof t) for (n = e; n < o; ++n) this[n] = t;
                                else {
