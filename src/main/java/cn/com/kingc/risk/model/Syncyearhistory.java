...
* @date 2018-01-08 15:05:35 中国标准时间
* @author
* @version
*/
public class Syncyearhistory implements Serializable{
    private static final long serialVersionUID = 1L;
        ...
        private  String riskIdentificationYearID;
    ...
    //无参构造方法
    public Syncyearhistory(){}

    //带参构造方法
    public Syncyearhistory (String coalMineName,String frameWorkID,Integer fSynHistoryID,String riskIdentificationYearID,Boolean fSynStatus,java.sql.Timestamp fSynTime,Integer fSynEmpID,String fSynEmpName,String fSynResultCode){
    ...
    @JsonIgnore
    public String getRiskIdentificationYearID() {
        return this.riskIdentificationYearID;
    }
    @JsonIgnore
    public void setRiskIdentificationYearID(String riskIdentificationYearID) {
        this.riskIdentificationYearID = riskIdentificationYearID;
    }
    @JsonIgnore
