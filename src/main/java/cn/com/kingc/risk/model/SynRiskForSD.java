...
* @version
*/
public class SynRiskForSD implements Serializable{
    ...
    public SynRiskForSD(String id, String identificationType, String addressId, String addressName, String postId, String riskType, String riskDesc, String riskLevel, String manageLevel, String dutyManager, String identifiDate, String expDate, String specificType, String specificName, String isDel) {
        this.id = id;
